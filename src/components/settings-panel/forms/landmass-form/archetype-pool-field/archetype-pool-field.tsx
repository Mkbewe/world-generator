  ...
  return (
    <Flex direction='column' gap='2'>
      <Flex justify='between' align='center'>
        <InfoLabel
          label='Shapes'
          description='Shape intents the structures are drawn from. Every structure picks one from the enabled pool, so one world can mix round, elongated and lagoon forms; at least one intent stays enabled.'
        />
