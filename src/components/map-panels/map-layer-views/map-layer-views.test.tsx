...
describe('MapLayerViews', () => {
  it('reports the view selected in the active group', async () => {
    const user = userEvent.setup();
    const onViewChange = vi.fn();
    render(
      <Theme>
        <MapLayerViews tabs={climateTabs()} activeTab='climate' onViewChange={onViewChange} />
      </Theme>
    );
  ...
  it('ignores clicks on unavailable views', async () => {
    ...
    render(
      <Theme>
        <MapLayerViews tabs={climateTabs(false)} activeTab='climate' onViewChange={onViewChange} />
      </Theme>
    );
